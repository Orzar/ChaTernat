...
public class SerieModel{
	 ...
	 * @param index The index to place the question at
	 ...
	 * @param index The index to place the chosen answer list at
	 * @param answer The chosen answer list to store
	 */
	 ...
	 * @param index The index to place the chosen answer list at
	 * @param answer the answer to insert into the list
	 */
	 ...
	 * @param index The index at which chosen answer list is stored 
	 ...
	 * @param index the question to check
	 * @return true if the chosen answer match the right answer of the question
	 */
	public boolean getResultsForQuestion(int index){
		//return (chosenAnswer.get(index).containsAll(rightAnswer.get(index)) && rightAnswer.get(index).containsAll(chosenAnswer.get(index)));
	 ...
	 */
	public int getCoherenceSerie() {
		int totalMark = 0;
		//TODO insérer dans le coherenceList, faire la somme selon les pondérations qu'on va stocker
		// dans answer ? question ? à voir
		// retourner la somme
		return totalMark;
	}
	 ...
	 * @param index The index of the question in the serie
